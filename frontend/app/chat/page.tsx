...
export default function ChatPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50">
      <div className="flex w-screen justify-center border-b border-gray-200 bg-white/80 py-4 backdrop-blur dark:border-slate-800 dark:bg-slate-900/80">
        <Header />
      </div>
        ...
        <main className="flex-1">
          <div className="mx-auto flex min-h-[calc(100vh-140px)] max-w-5xl flex-col px-6 py-8 lg:px-10">
            <div className="mb-6 flex justify-center">
              <div className="relative max-w-3xl rounded-3xl bg-white px-6 py-4 text-sm leading-relaxed shadow-sm ring-1 ring-slate-200 dark:bg-slate-900/90 dark:ring-slate-800">
                ...
                >
                  <div
                    className={`max-w-2xl rounded-3xl px-5 py-4 text-sm leading-relaxed shadow-sm transition ${
                      message.type === "user"
                        ? "bg-amber-400 text-slate-900 dark:bg-amber-400 dark:text-slate-950"
            ...
            <div className="mt-6">
              <form onSubmit={handleSendMessage} className="relative mx-auto max-w-3xl">
                <div className="flex items-center gap-3 rounded-full border border-slate-300 bg-white px-4 py-2 shadow-inner focus-within:border-amber-400 dark:border-slate-700 dark:bg-slate-900/90">
                  <input
                    type="text"
                    value={input}
