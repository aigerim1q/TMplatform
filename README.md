...
- # Notifications
- Подключено получение уведомлений:
  - `GET /notifications`
- Реализована отметка уведомления как прочитанного:
  - `PUT /notifications/:id/read`
- Все запросы защищены JWT (accessToken)
- Уведомления доступны только авторизованному пользователю
